...
async def start(client, message):
   if message.chat.type == 'private':
       await Jebot.send_message(
               ...
               text="""<b>Halo!, Saya Adalah Youtube Downloader Bot
Saya Bisa Mendownload Lagu / Video Dari Youtube Dibuat Oleh @Riogroupsupport
Tekan Tombol Help Untuk Melihat Fitur Menarik Saya</b>""",   
                            reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
                                            "Help", callback_data="help"),
                                        InlineKeyboardButton(
                                            "Channel", url="https://t.me/rioprojects")
                                    ],[
                                      InlineKeyboardButton(
...
Cukup Kirim Link Audio / Video Dari Youtube, Bot Ini Akan Bekerja Dengan Cepat!
...
<b>♞ Developer:</b> <a href="https://t.me/fckualot">Rio</a>
<b>♞ Support:</b> <a href="https://t.me/rioprojects">BOTs Support</a>
<b>♞ Library:</b> <a href="https://github.com/pyrogram/pyrogram">Pyrogram</a>
<b>Join @rioprojects</b>""",
     reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
...
async def ytdl_with_button(c: Client, message: Message):
    if Config.UPDATES_CHANNEL is not None:
        try:
            ...
            await c.send_message(
                chat_id=message.chat.id,
                text="Ada Sesuatu Yang Salah. Contact my [Support Group](https://t.me/Riogroupsupport).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
